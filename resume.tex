...
development and board bring-up with eleven years of complete life cycle experience.\\
...
\section{PROFESSIONAL EXPERIENCE}
    ...
    {\sl Software Engineering Lead} \hfill September  2014 - present
    \vspace{1mm}
    \begin{itemize}
        \item Integrated Linux Qualcomm MSM IPQ806X support during board bringup   
        \item Developed Linux device driver for the TI CC254X BLE chip
        \item Spearheaded an internal build system modernization project using Yocto
        \item Debugged countless early boot and platform issues
    \end{itemize}
    \vspace{1mm}
    ...
    \begin{itemize}
       ...
       \item Designed and Developed a cross-platform ZigBee gateway service using Erlang
    ...
    \vspace{1mm}
    \begin{itemize} 
       \item Lead internal trade study of distributed communication framework technologies
    ...
    \begin{itemize} 
       ...
       \item Lead an independent project to develop and sell an Application
       Programming Interface for custom serial hardware using QuickUSB   
    ...
    \vspace{1mm}
    \begin{itemize} 
       \item Ported embedded real-time Xserver from VxWorks 5.5 to
       ...
       \item Ported a Radstone PowerPC Single Board Computer Board Support
         Package from VxWorks 5.5 to VxWorks 6.6
    ...
    \begin{itemize} 
      ...
      \item Designed embedded video validation software for real-time AE653
      avionics displays
    ...
    \begin{itemize} 
      ...
      \item Graduated from Platoon Development Leadership Course
